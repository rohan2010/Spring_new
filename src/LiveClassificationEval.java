...
public class LiveClassificationEval extends PApplet implements AudioListener
{
	...
	String[] modelLabels = {"100Deg", "90Deg", "80Deg", "70Deg", "60Deg", "50Deg", "40Deg", "30Deg"};
	int fileIndex = 0;
	...
	String rawTrainingFile = "../models/100_to_30_2300datapointsClassification.csv";
	...
	public void keyReleased()
	{
	  ...
	  if (key=='t')
	  {
		  CLS = new WekaClassifier(rawTrainingFile);
	  }
